---
title:  " 영어 끝말잇기 from programmers "
...
2xn 타일링 문제에서 떨어진 자신감을 되찾고자 다시한번 쉬운문제에 도전했다
...
def solution(n, words):
    ...
    for idx,x in enumerate(words[1:]):
        if words[idx][-1] != x[0] or x in words[:idx]:
            return [(idx+1)%n + 1,int((idx+1)/n) + 1]
